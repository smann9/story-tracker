...
//var pos1 = new Cartesian3.fromDegrees(33.7741337,-84.3988109,21);
//var pos2 = new Cartesian3.fromDegrees(33.7743221,-84.3973638,21);
//var pos3 = new Cartesian3.fromDegrees(33.7743269,-84.3964173,21);
//var pos4 = new Cartesian3.fromDegrees(33.7748386,-84.3955992,21);
...
loader2.load('images/box.png', function (texture) {
    var geometry = new THREE.BoxGeometry(1, 1, 1);
    var material = new THREE.MeshBasicMaterial({ map: texture });
    var mesh = new THREE.Mesh(geometry, material);
    box2.add(mesh);
